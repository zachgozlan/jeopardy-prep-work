---
title: "<b>How I Got</b> (Two to Three Questions) <b>Smart</b>(er in Five Months)"
...
My goal was to get to an average of 40 questions right per episode, on the assumption that if I could swing that plus a 50% buzzer rate I'd have answered my "share" of the questions and have a decent-enough shot at winning.^[They didn't start releasing #jeopardata until about six weeks after my tape day wrapped; as you could probably guess, I would have <i>killed</i> for that information during this process.] I repeated the category quizzes about once a month/as needed to measure progress and check to see if I needed to re-prioritize topics, and of course I also watched the show religiously to see if I was really moving the needle.
